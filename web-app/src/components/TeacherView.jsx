      ...
      <div className="min-h-screen bg-game p-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="neon-glass rounded-3xl p-6 mb-6">
            ...
            {players.length === 0 ? (
              <p className="text-white/20 text-center py-4">
                Ootame mängijaid...
              </p>
            ) : (
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {players.map(([uid, player]) => (
                  <div
                    key={uid}
                    className="neon-glass-light rounded-2xl p-3 flex items-center justify-between gap-2"
                  >
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className={timerClass}>
              <div
                className={`text-8xl font-black font-mono ${timerColor} transition-colors duration-500`}
              >
                {timerValue}
              </div>
            </div>
